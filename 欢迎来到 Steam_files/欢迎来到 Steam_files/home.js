...
GHomepage = {
	...
	RenderRecommendedSpotlight: function( unAppID, strDescription, bNoDSFlag )
	{
		...
		if ( !strHeaderURL )	// wishlist items may not have a header loaded
			strHeaderURL = 'http://cdn.edgecast.steamstatic.com/steam/apps/' + unAppID + '/header.jpg';
...
{
	return 'http://cdn.edgecast.steamstatic.com/steamcommunity/public/images/avatars/' + strAvatarHash.substr( 0 , 2 ) + '/' + strAvatarHash + ( sizeStr || '' ) + '.jpg';
}

function GetScreenshotURL( appid, filename, sizeStr )
{
	if( sizeStr )
		return 'http://cdn.edgecast.steamstatic.com/steam/' + 'apps/' + appid + '/' + filename.replace('.jpg', sizeStr + '.jpg');

	return 'http://cdn.edgecast.steamstatic.com/steam/' + 'apps/' + appid + '/' + filename;
}
